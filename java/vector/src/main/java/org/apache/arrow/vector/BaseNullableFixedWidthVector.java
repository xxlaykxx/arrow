...
public abstract class BaseNullableFixedWidthVector extends BaseValueVector
   ...
   private void allocateBytes(final long valueBufferSize, final long validityBufferSize) {
      ...
      /* Zeroing out validity buffer is always important. Zeroing out
       * data buffer is important only for NullableBitVector. Probably
       * no harm in zeroing out regardless.
       */
      zeroVector();
   }

...
public class VectorUnloader {
  ...
  private final boolean allignBuffers;

  public VectorUnloader(VectorSchemaRoot root) {
    this(root, true, true);
  }

  public VectorUnloader(VectorSchemaRoot root, boolean includeNullCount, boolean allignBuffers) {
    this.root = root;
    this.includeNullCount = includeNullCount;
    this.allignBuffers = allignBuffers;
  }
  ...
  public ArrowRecordBatch getRecordBatch() {
    ...
    return new ArrowRecordBatch(root.getRowCount(), nodes, buffers, allignBuffers);
  }
